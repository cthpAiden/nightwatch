...
const CATALOG := [
	{"id": "more_offerings", "name": "UPG_MORE_OFFERINGS_NAME", "desc": "UPG_MORE_OFFERINGS_DESC", "cost": 12},
	...
	{"id": "auto_relight", "name": "UPG_AUTO_RELIGHT_NAME", "desc": "UPG_AUTO_RELIGHT_DESC", "cost": 26},
	{"id": "bright_altar", "name": "UPG_BRIGHT_ALTAR_NAME", "desc": "UPG_BRIGHT_ALTAR_DESC", "cost": 30},
	{"id": "extra_ward", "name": "UPG_EXTRA_WARD_NAME", "desc": "UPG_EXTRA_WARD_DESC", "cost": 34},
]
